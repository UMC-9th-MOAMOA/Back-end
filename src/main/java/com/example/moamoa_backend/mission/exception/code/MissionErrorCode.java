...
public enum MissionErrorCode implements BaseErrorCode {
    ...
    INVALID_YOUTUBE_URL(HttpStatus.BAD_REQUEST, "MISSION400_2", "유효하지 않은 유튜브 URL입니다."),
    YOUTUBE_VIDEO_NOT_FOUND(HttpStatus.NOT_FOUND, "MISSION404_2", "해당 유튜브 영상을 찾을 수 없습니다. (삭제되었거나 비공개)"),
    YOUTUBE_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "MISSION500_2", "유튜브 API 연동 중 오류가 발생했습니다.");
