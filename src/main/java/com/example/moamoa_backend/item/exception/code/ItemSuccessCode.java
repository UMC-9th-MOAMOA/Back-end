...
public enum ItemSuccessCode implements BaseSuccessCode {
	...
	ITEM_LIST_OK(HttpStatus.OK, "ITEM200_1", "아이템 목록 조회에 성공했습니다."),
	ITEM_PURCHASE_OK(HttpStatus.OK, "ITEM200_2", "아이템 구매에 성공했습니다."),
	AVATAR_EQUIP_OK(HttpStatus.OK, "ITEM200_3", "아바타 착장 변경에 성공했습니다."),
