...
public class MissionConverter {
	...
	public MissionResponseDto.MissionDetail toMissionDetail(Mission mission, MemberMission memberMission, Map<Long, String> correctHistoryMap) {
		...
		List<String> keywords = mission.getMissionKeywords()
			.stream()
	...
	public MissionResponseDto.SearchResponse toSearchResponse(Slice<Mission> missionSlice,
		Map<Long, MemberMission> myMissionMap) {
