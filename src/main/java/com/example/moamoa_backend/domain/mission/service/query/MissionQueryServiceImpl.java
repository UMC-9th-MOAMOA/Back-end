...
public class MissionQueryServiceImpl implements MissionQueryService {
	...
	public MissionResponseDto.MissionDetail getMissionDetail(Long memberId, Long missionId) {
		Mission mission = missionRepository.findByIdWithDetail(missionId)
	...
	public List<MissionResponseDto.RecommendResult> getTodayRecommendMissions(Long memberId, Integer requestTime, Boolean isRefresh) {
		...
		List<MemberMission> memberMissions = memberMissionRepository.findAllByMemberIdAndMissionIdIn(memberId,
			missionIds);
	...
	@Override
	public MissionResponseDto.SearchResponse getMyMissions(Long memberId, String status, String condition,
		Long categoryId, Pageable pageable) {
		Slice<MissionResponseDto.RecommendResult> slice = missionRepository.getMyMissions(memberId, status, condition,
			categoryId, pageable);
