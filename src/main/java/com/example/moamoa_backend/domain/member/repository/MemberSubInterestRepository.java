...
import com.example.moamoa_backend.domain.member.entity.mapping.MemberSubInterest;
...
public interface MemberSubInterestRepository extends JpaRepository<MemberSubInterest, Long> {
	...
	/**
	 * 인터페이스 프로젝션:
	 * (interestId, subInterestId) 형태로 사용
	 */
	...
	/**
	 * 조회(응답 구성용):
	 * 세부 관심사들을 (interestId, subInterestId) pair로 가져옴.
