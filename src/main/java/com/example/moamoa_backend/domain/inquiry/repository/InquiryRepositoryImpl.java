...
public class InquiryRepositoryImpl implements InquiryRepositoryCustom {
	...
	@Override
	public List<InquiryQueryResDto.MyInquiryItem> findMyInquiryItems(Long memberId,
	...
	private BooleanExpression answerStatusFilter(InquiryQueryReqDto.MyInquiryList cond) {
		QInquiry inquiry = QInquiry.inquiry;
		if (cond.answerStatus() == null || cond.answerStatus() == InquiryQueryReqDto.AnswerStatus.ALL)
			return null;
